...
?>
        <div class="row">
            <div class="col p-0 m-0">
                <div class="card rounded-0 border-0" id="SZEGED">
                    ...
                    <div class="card-body p-4">
                        <div class="container">
                            ...
                            <div class="row mb-4">
                                <div class="col p-0 m-0">
                                    <p class="p-0 m-0 price"><?php echo $row['rent'] ?> Ft</p>
                                </div>
                                <div class="col p-0 m-0">
                                    <p class="p-0 m-0 price"><?php echo $row['cost'] ?> Ft</p>
                                </div>
                            </div>
                            <div class="row mb-4">
                                <div class="col p-0 m-0">
